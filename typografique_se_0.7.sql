...
--
-- Värd: localhost:8889
-- Tid vid skapande: 09 jan 2015 kl 17:49
...
--
-- Dumpning av Data i tabell `FORM`
--
...
('6007191155', 'Mikael', 'Jonsson', 'meka@mail.com'),
('8712120000', 'Magnus', 'Ulenius', 'magnus.ulenius@gmail.com'),
('9107040000', 'Axel', 'Jonsson', 'axel.jonsson@live.com'),
('9107044456', 'Axel', 'Jonsson', 'axel@mail.com');
...
--
-- Dumpning av Data i tabell `RESULTSTRING`
--

INSERT INTO `RESULTSTRING` (`str_key`, `string`) VALUES
(1, 'Inga tendenser'),
(2, 'Svaga tendenser'),
(3, 'Finns tendenser'),
(4, 'Starka tendenser');
...
--
-- Dumpning av Data i tabell `VARDARE`
--
